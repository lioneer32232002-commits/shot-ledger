...
- [docs/SPEC_M1.md](docs/SPEC_M1.md) / [SPEC_M1_5.md](docs/SPEC_M1_5.md) / [SPEC_M1_6.md](docs/SPEC_M1_6.md) — 各里程碑實作規格
- [docs/BRANDING.md](docs/BRANDING.md) — 視覺系統與 OG 圖規格

## 狀態

M1.6 已上線（核心迴圈＋挑戰階梯＋逐球輸入＋誠實機制＋球員數據）。
進行中：實地使用回饋收集。下一步：M2（統計分頁全套、成績分享卡、週目標）、
M3（深色模式、PWA、雙語）。詳見 [docs/HANDOFF_20260713.md](docs/HANDOFF_20260713.md)。
