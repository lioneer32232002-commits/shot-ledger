...
手刻扁平 SVG（2026-07-13 v4 定案：**漸大漸亮的軌跡點列**）：籃球橘
圓角方塊（rx 14/64）＋沿拋物線（M10 52 Q32 2 52 38 取樣）排列的
5 顆暖米白軌跡點——半徑 1.6→4.4 漸大、fill-opacity .35→.92 漸亮
（在橘底上形成暖色漸層）——終點一顆 r7 實心球。與 App 分享卡的
dotted trajectory 同語言。inline data URI 直接放 index.html。
