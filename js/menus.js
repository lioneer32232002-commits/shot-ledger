...
export const MENUS = [
  {
    ...
    passDesc: '2 分 ≥45%',
    signature: { label: '課表收官', desc: '最後一輪罰球投 7 進以上' },
  ...
  },
  {
    ...
    signature: { label: '折返穩定', desc: '左右兩翼命中率差 ≤10 個百分點' },
  ...
  },
  {
    ...
    signature: { label: '先發制人', desc: '前 3 輪就打出過關命中率' },
  ...
  },
  {
    ...
    passDesc: '2 分 ≥52%',
    signature: { label: '單點鑽研', desc: '罰球線頂沒有一輪失手過半' },
  ...
  },
  {
    ...
    passDesc: '2 分 ≥55%',
    signature: { label: '金雞獨立', desc: '單輪 8 進的手感時刻' },
  ...
  },
  {
    ...
    passDesc: '3 分 ≥32%',
    signature: { label: '底角殺手', desc: '兩側底角合計 ≥40%' },
  ...
  },
  {
    ...
    passDesc: '3 分 ≥35%',
    signature: { label: '儀式不亂', desc: '沒有任何一輪掉到 3 球以下' },
  ...
  },
  {
    ...
    passDesc: '3 分 ≥38%',
    signature: { label: '穩了才換點', desc: '每個連兩輪的點位，第二輪不退步' },
  ...
  },
  {
    ...
    passDesc: '3 分 ≥40%',
    signature: { label: '量產不停', desc: '下半場總進球不輸上半場' },
  ...
  },
  {
    ...
    passDesc: '深 3 ≥30%',
    signature: { label: 'Dame Time', desc: '最後一個深三輪投 4 進以上' },
  ...
  },
  {
    ...
    signature: { label: '左右開弓', desc: '左右上籃各 ≥70%' },
  ...
  },
  {
    ...
    passDesc: '3 分 ≥42%',
    signature: { label: '全點開花', desc: '每個三分點位都至少 4 進' },
  ...
  },
  {
    ...
    signature: { label: '雙修', desc: '3 分與深 3 同場皆超門檻 5 個百分點' },
